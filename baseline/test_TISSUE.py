...
if __name__ == '__main__':
    ...
    for data_k in datasets_list:
        ...
        outdir = '../results/%s/tangram_tissue_nofilter'%(opt.dataset)
        ...
        for k in range(10):
            ...
            tissue.predict_gene_expression(Spatial_adata, RNAseq_adata, [target_gene], method="tangram", n_folds=10, n_pv=10)
